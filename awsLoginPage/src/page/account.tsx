        ...
        <div className="xl:grid xl:grid-cols-[40%_60%]">
            <div className="hidden xl:flex w-full h-full">
                <div className="w-full h-screen grid grid-rows-[15%_75%_10%] bg-[#00539C0A]">
                    ...
                    <div className="">
                        <Onglets textColor="text-[black]" icons='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#000"><path d="M480-480q-66 0-113-47t-47-113q0-66 47-113t113-47q66 0 113 47t47 113q0 66-47 113t-113 47ZM160-160v-112q0-34 17.5-62.5T224-378q62-31 126-46.5T480-440q66 0 130 15.5T736-378q29 15 46.5 43.5T800-272v112H160Zm80-80h480v-32q0-11-5.5-20T700-306q-54-27-109-40.5T480-360q-56 0-111 13.5T260-306q-9 5-14.5 14t-5.5 20v32Zm240-320q33 0 56.5-23.5T560-640q0-33-23.5-56.5T480-720q-33 0-56.5 23.5T400-640q0 33 23.5 56.5T480-560Zm0-80Zm0 400Z" /></svg>' bigText="Inscription" smallText="Entrez vos informations personnelles." />
                    ...
                    <div className="flex justify-between px-12">
                        ...
                        <span className="font-bold flex items-center cursor-pointer text-[var(--primary-color)]">
                            SignIn
                        </span>
                    </div>
                </div>
            ...
            <div className="">
                <div className="px-[2rem] lg:px-[10rem] sm:px-[4rem] pt-[1rem]">
                    ...
                    <InputEmail type="text" label="Nom" placeHolder="gewel henri" />
                    <InputEmail type="email" label="Email" placeHolder="abc@example.com" />
                    <InputPassword />
                    <Ligne2 />
                    <Github />
                    <Google />
                    <CreateAccount href="/otp" />
                    <Text />
                    <div className="mb-12 xl:mb-[4rem]"></div>
                    <div className="flex gap-2 2xl: justify-center items-center fixed bottom-1 left-1/2 -translate-x-1/2 px-[2rem] w-full ">
